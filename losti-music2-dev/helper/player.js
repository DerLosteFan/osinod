...
class Player {
  ...
  static async reset({channel_id, guild_id, keyDetails} = {}) {
    ...
    const embed = {
      title: `Vibing Alone ️`,
      url: ``,
      description: `Enter any song title you want and it will be played.`,
      color: 0xd43790,
      image: {
        url: 'https://cdn.discordapp.com/attachments/884862841063100427/934089763521191966/tumblr_1cc8a6a4dad87b7fd0e37f58412cfb7d_05d7e544_640.gif',
      },
      thumbnail: {
        url: 'https://cdn.discordapp.com/attachments/884862841063100427/934047938387263488/Bildschirmfoto_2022-01-21_um_12.32.29.png',
      },
    };
